...
public class ArticleConfig {
    @Bean
    List<Article> articleList(ArticleRepository articleRepository) {
        return articleRepository.saveAll(List.of(
                ...
                new Article("Dog", "Animal", "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9b/Chin_posing.jpg/1280px-Chin_posing.jpg", "The dog or domestic dog (Canis familiaris[4][5] or Canis lupus familiaris[5]) is a domesticated descendant of the wolf. The dog is derived from an ancient, extinct wolf,[6][7] and the modern wolf is the dog's nearest living relative.[8] The dog was the first species to be domesticated,[9][8] by hunter-gatherers over 15,000 years ago,[7] before the development of agriculture.[1] Due to their long association with humans, dogs have expanded to a large number of domestic individuals[10] and gained the ability to thrive on a starch-rich diet that would be inadequate for other canids.[11] The dog has been selectively bred over millennia for various behaviors, sensory capabilities, and physical attributes.[12] Dog breeds vary widely in shape, size, and color. They perform many roles for humans, such as hunting, herding, pulling loads, protection, assisting police and the military, companionship, therapy, and aiding disabled people. Over the millennia, dogs became uniquely adapted to human behavior, and the human-canine bond has been a topic of frequent study.[13] This influence on human society has given them the sobriquet of \"man's best friend\".[14]"),
                new Article("Mouse", "Animal", "https://upload.wikimedia.org/wikipedia/commons/thumb/0/0d/%D0%9C%D1%8B%D1%88%D1%8C_2.jpg/220px-%D0%9C%D1%8B%D1%88%D1%8C_2.jpg"),
                new Article("Computer keyboard", "Electronics", "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/LenovoKeyboard.jpg/220px-LenovoKeyboard.jpg"),
                new Article("Duck", "Animal", "https://upload.wikimedia.org/wikipedia/commons/thumb/b/bf/Bucephala-albeola-010.jpg/220px-Bucephala-albeola-010.jpg"),
                new Article("Bird", "Animal"),
                new Article("Racoon", "Animal"),
                new Article("Snake", "Animal"),
                new Article("Serotonin", "Chemistry", "https://upload.wikimedia.org/wikipedia/commons/thumb/2/24/Serotonin-Spartan-HF-based-on-xtal-3D-balls-web.png/220px-Serotonin-Spartan-HF-based-on-xtal-3D-balls-web.png"),
                new Article("Ant", "Animal"),
                new Article("Bee", "Animal"),
                new Article("Headphones", "Electronics", "https://upload.wikimedia.org/wikipedia/commons/thumb/0/00/S%C5%82uchawki_referencyjne_K-701_firmy_AKG.jpg/220px-S%C5%82uchawki_referencyjne_K-701_firmy_AKG.jpg"),
                new Article("Worm", "Animal"),
                new Article("Tick", "Animal"),
                new Article("Fly", "Animal"),
                new Article("Human", "Animal"),
                new Article("Broccoli", "Plant", "https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/Broccoli_and_cross_section_edit.jpg/220px-Broccoli_and_cross_section_edit.jpg"),
                new Article("Chimpanzee", "Animal"),
                new Article("Monkey", "Animal"),
                new Article("Mouse", "Electronics", "https://upload.wikimedia.org/wikipedia/commons/thumb/2/22/3-Tasten-Maus_Microsoft.jpg/220px-3-Tasten-Maus_Microsoft.jpg"),
                new Article("Donkey", "Animal"),
                new Article("Horse", "Animal"),
                new Article("Alexander Cameron Rutherford", "People", "https://upload.wikimedia.org/wikipedia/commons/thumb/6/64/Alexander_Cameron_Rutherford_-_Elliott_And_Fry_%28cropped%29.jpg/220px-Alexander_Cameron_Rutherford_-_Elliott_And_Fry_%28cropped%29.jpg"),
                new Article("Amphetamine", "Chemistry", "https://upload.wikimedia.org/wikipedia/commons/thumb/5/57/D-Amphetamine_molecule_ball_from_xtal.png/250px-D-Amphetamine_molecule_ball_from_xtal.png"),
                new Article("Romania", "Geography", "https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/Regiuni_de_dezvoltare.svg/300px-Regiuni_de_dezvoltare.svg.png")
        ));
    }
}
